...
const sendPaymentConfirmationEmail = async (email, paymentDetails) => {
  const mailOptions = {
    from: {
      name: 'Stubits',
      address: 'payments@stubits.com'
    },
    replyTo: 'support@stubits.com',
    to: email,
    subject: 'Payment Confirmed! Welcome to Stubits Premium ✨',
    priority: 'high',
    headers: {
      'List-Unsubscribe': `<mailto:${process.env.EMAIL_USER}?subject=unsubscribe>`,
      'Precedence': 'bulk',
    ...
    html: `
      ...
      <html>
        <head>
          ...
          <meta name="color-scheme" content="light">
          <meta name="supported-color-schemes" content="light">
          <title>Payment Confirmed - Stubits Premium</title>
        </head>
        <body style="margin: 0; padding: 0; background-color: #0a0a0a; font-family: 'Inter', Arial, sans-serif;">
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width: 600px; margin: 0 auto;">
            <tr>
              <td style="padding: 40px 20px; text-align: center;">
                ...
                <div style="margin-bottom: 32px;">
                  <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/WhatsApp%20Image%202025-01-27%20at%2021.16.27_5fe7b30d-Photoroom-PGmOIIP1qxx8q6FGrmXjWeQ3tYTMFR.png" 
                       ...
                       style="width: 80px; height: 80px; border-radius: 50%; margin-bottom: 24px; border: 3px solid #9333ea;"
                  >
                  <h1 style="color: #ffffff; font-size: 32px; margin: 0;">Payment <span style="background: linear-gradient(45deg, #9333ea, #7928ca); -webkit-background-clip: text; background-clip: text; color: transparent;">Confirmed!</span></h1>
                </div>

                <!-- Main Content -->
                <div style="background: linear-gradient(180deg, rgba(147, 51, 234, 0.1), rgba(121, 40, 202, 0.1)); border-radius: 16px; padding: 32px; margin-bottom: 32px; border: 1px solid rgba(147, 51, 234, 0.2);">
                  <h2 style="color: #9333ea; font-size: 24px; margin: 0 0 16px;">Thank You for Your Purchase! 🎉</h2>
                  <p style="color: #a0a0a0; font-size: 16px; line-height: 1.6; margin: 0 0 24px;">Your payment has been approved and your premium access is now active.</p>
                  
                  <!-- Purchase Details -->
                  <div style="text-align: left; margin: 32px 0; background: rgba(147, 51, 234, 0.05); padding: 20px; border-radius: 12px;">
                    <h3 style="color: #ffffff; font-size: 18px; margin-bottom: 16px;">Your Premium Benefits:</h3>
                    <div style="color: #a0a0a0; font-size: 14px;">
                      ⚡ Unlimited Access to Study Materials<br>
                  ...
                  <!-- CTA Button -->
                  <a href="https://stubits.com/dashboard" 
                     style="display: inline-block; background: linear-gradient(45deg, #9333ea, #7928ca); color: white; text-decoration: none; padding: 16px 32px; border-radius: 12px; font-weight: bold; margin: 24px 0;">
                    Start Learning Now
                  </a>
                </div>
                ...
                <!-- Support Section -->
                <div style="margin-top: 32px;">
                  <p style="color: #666666; font-size: 14px; margin-bottom: 16px;">Need help getting started?</p>
                  <div>
                    <a href="https://discord.gg/TpfNFRWnhd" style="color: #9333ea; text-decoration: none; margin: 0 12px;">Join Discord</a>
                    <a href="mailto:support@stubits.com" style="color: #9333ea; text-decoration: none; margin: 0 12px;">Contact Support</a>
                  </div>
                </div>
